  ...
  <footer className="flex flex-col text-center gap-2">
    <div className="flex justify-center text-[#336699] text-sm">
      <ul className="flex items-center gap-1">
        ...
        <span className="text-gray-500">|</span>
        <li className="hover:underline cursor-pointer">buttons</li>
        <span className="text-gray-500">|</span>
        <li className="hover:underline cursor-pointer">widget</li>
        <span className="text-gray-500">|</span>
    ...
    <div className="text-xs text-gray-500">
      ...
      Policy(c) 2008 CondeNet, Inc. All rights reserved.
    </div>
  </footer>
);
